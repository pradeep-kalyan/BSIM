                ...
                <div key={index} className="grid grid-cols-3 gap-4 mb-4 items-end">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onRoleChange(index, "salary_per_head", e.target.value)}
                            min="0"
                            step="0.01"
                            className="w-full p-2 rounded bg-slate-800 text-white"
                        />
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                onChange={(e) => onRoleChange(index, "head_count", e.target.value)}
                                min="0"
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onTrainingBudgetChange(parseFloat(e.target.value) || 0)}
                        min="0"
                        step="0.01"
                        className="w-full p-2 rounded bg-slate-800 text-white"
                    />
