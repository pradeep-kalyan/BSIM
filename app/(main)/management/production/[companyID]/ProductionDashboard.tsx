...
import CreateDecision from "../../_components/CreateDecision";
...
interface Product {
  ...
  launch_period: number | null; // Changed from string to number
  ...
  }>; // Added for the included relation
}
    ...
    <div className="w-full flex-1 bg-slate-900 text-white p-8 space-y-8">
      <div className="mb-6">
        ...
        <p className="text-gray-300 text-lg">
          Period {} | Cash: {formatCurrency(company.cash_balance)}
        </p>
      </div>
      ...
      <div className="flex space-x-2 mb-6 border-b border-gray-600">
        <button
          className={`px-4 py-2 font-semibold focus:outline-none transition-colors ${
            activeTab === "overview"
              ...
              <Card
                ...
                content={`${
                  totalProductionCapacity > 0
                    ? Math.round(
                        (totalInventory / totalProductionCapacity) * 100
                      )
                    : 0
                }%`}
                width={280}
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(averageSustainability / 10) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
