...
interface HRDecisionPanelProps {
    ...
    initialHistory: PerformanceResult[];
}

export default function HRDecisionPanel({
    companyId,
    currentPeriod,
    initialHistory,
}: HRDecisionPanelProps) {
    ...
    const [performanceHistory, setPerformanceHistory] = useState<PerformanceResult[]>(initialHistory);
