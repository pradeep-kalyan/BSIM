...
CREATE TABLE `company_histories` (
    ...
    INDEX `company_histories_company_id_idx`(`company_id`),
    UNIQUE INDEX `company_histories_company_id_period_key`(`company_id`, `period`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
    ...
    UNIQUE INDEX `products_company_id_name_key`(`company_id`, `name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `production` (
    ...
    `storage_capacity` INTEGER NULL DEFAULT 0,
    ...
    INDEX `production_company_id_idx`(`company_id`),
    INDEX `production_product_id_idx`(`product_id`),
    UNIQUE INDEX `production_company_id_product_id_period_key`(`company_id`, `product_id`, `period`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `hr_decisions` (
    ...
    `total_employee_count` INTEGER NULL DEFAULT 0,
...
CREATE TABLE `rd` (
    ...
    INDEX `rd_company_id_idx`(`company_id`),
    UNIQUE INDEX `rd_company_id_period_key`(`company_id`, `period`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `marketing` (
    ...
    INDEX `marketing_company_id_idx`(`company_id`),
    UNIQUE INDEX `marketing_company_id_period_key`(`company_id`, `period`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
