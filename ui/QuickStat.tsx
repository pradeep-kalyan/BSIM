...
import { QuickStatProps } from "@/app/(main)/homepage/[companyID]/types";
...
const TrendIcon =
  ...
  return (
    <div
      className={`flex items-center gap-4 rounded-xl p-4 transition-colors duration-300 shadow-md ${colorClasses[color]}`}
    >
